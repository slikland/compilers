...
PreloaderView = (function(_super) {
  ...
  function PreloaderView() {
    ...
    this.create = __bind(this.create, this);
    this.createStart = __bind(this.createStart, this);
    PreloaderView.__super__.constructor.call(this, null, 'PreloaderView');
  }

  PreloaderView.prototype.createStart = function(evt) {
    if (evt == null) {
      evt = null;
    }
    return PreloaderView.__super__.createStart.apply(this, arguments);
  };

  PreloaderView.prototype.create = function(evt) {
    if (evt == null) {
      evt = null;
    }
    return PreloaderView.__super__.create.apply(this, arguments);
  };

  PreloaderView.prototype.createComplete = function(evt) {
    if (evt == null) {
      evt = null;
    }
    return PreloaderView.__super__.createComplete.apply(this, arguments);
  };

  PreloaderView.prototype.showStart = function(evt) {
    if (evt == null) {
      evt = null;
    }
    return PreloaderView.__super__.showStart.apply(this, arguments);
  };

  PreloaderView.prototype.show = function(evt) {
    if (evt == null) {
      evt = null;
    }
    return PreloaderView.__super__.show.apply(this, arguments);
  };

  PreloaderView.prototype.showComplete = function(evt) {
    if (evt == null) {
      evt = null;
    }
    return PreloaderView.__super__.showComplete.apply(this, arguments);
  };

  PreloaderView.set({
    progress: function(p_value) {
      return this.text = p_value;
    }
  });

  PreloaderView.prototype.hideStart = function(evt) {
    if (evt == null) {
      evt = null;
    }
    return PreloaderView.__super__.hideStart.apply(this, arguments);
  };

  PreloaderView.prototype.hide = function(evt) {
    if (evt == null) {
      evt = null;
    }
    return PreloaderView.__super__.hide.apply(this, arguments);
  };

  PreloaderView.prototype.hideComplete = function(evt) {
    if (evt == null) {
      evt = null;
    }
    return PreloaderView.__super__.hideComplete.apply(this, arguments);
  };

  PreloaderView.prototype.destroy = function(evt) {
    if (evt == null) {
      evt = null;
    }
    return PreloaderView.__super__.destroy.apply(this, arguments);
  };
