...
class MovieTrackingParser
	...
	TrackingParser::trackingKey = {"Units Per Second":"framesPerSecond", "Source Width":"width", "Source Height":"height", "Position":"position", "Scale":"scale", "Rotation":"rotation", "Frame":"frame", "X pixels":"x", "Y pixels":"y"}
	...
	@parse:(p_string)->
		return TrackingParser.getInstance().parse(p_string)
