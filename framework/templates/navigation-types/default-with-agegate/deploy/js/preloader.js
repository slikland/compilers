...
Preloader = (function(_super) {
  ...
  Preloader.prototype.hidePreloderView = function(evt) {
    ...
    if ((this.ageGate != null) && (this.answer != null)) {
      this.destroyAgeGate();
    }
  ...
  Preloader.prototype.attachAgeGate = function(evt) {
    ...
    document.body.appendChild(this.ageGate.element);
    this.buttons = new BaseDOM('div');
    this.buttons.css({
      'text-align': 'center'
    });
    this.ageGate.appendChild(this.buttons.element);
    this.buttonYes = new BaseDOM('button');
    ...
    this.buttonNo = new BaseDOM('button');
  ...
  Preloader.prototype.destroyAgeGate = function(evt) {
    ...
    document.body.removeChild(this.ageGate.element);
